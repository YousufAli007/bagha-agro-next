...
import { Link } from "react-router"; // Link কম্পোনেন্ট ইমপোর্ট করা হলো

// কাস্টম লিঙ্ক কম্পোনেন্টকে ফ্রেমার মোশনের জন্য রেডি করা হলো
  ...
  return (
    <section className="relative h-[85vh] w-full flex items-center justify-center overflow-hidden bg-emerald-950">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10 space-y-6">
        ...
        >
          সঠিক সময়ে সঠিক পরামর্শ, উন্নত জাতের বীজ-চারা এবং সরাসরি পাইকারি বাজারের সুবিধা নিয়ে 
        ...
        >
          {/*sevice btn */}
          <MotionLink
            to="/agriculture" // এখানে আপনার কৃষি সেবা পেজের পাথ দিয়ে দিন
          ...
          {/* ai btn*/}
          <MotionLink
            to="/ai-assistant" // এখানে আপনার AI সহকারী পেজের পাথ দিয়ে দিন
